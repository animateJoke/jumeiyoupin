<template>
    <div style="width: 100%;height: 100%;">
        ...
        <form>
            <input type="text" v-model="username" placeholder="请输入用户名"/> <span v-text="msg1"></span>
            <input type="text" v-model="tel" placeholder="请输入11位号码"/> <span v-text="msg2"></span>
            <input type="password" v-model="pwd" placeholder="6-16位登录密码"/> <span v-text="msg3"></span>
